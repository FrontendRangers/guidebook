...
markedRenderer.code = function (code, language) {
    ...
    var outputCodeTitle = '<label class="sg-example-code-title"><input type="radio">Code</label>';
    var outputCode = format('<div class="sg-example-code">{0}<pre><code class="{1}">{2}</code></pre></div>', [outputCodeTitle, codeLang, renderedCode]);
